...
console.log("Opdracht 2: hoeveelheid minuten verwacht (als een getal) en teruggeeft hoeveel seconden dat zijn.")
...
function calculateDogYears(dogYears) {
  return "Jouw hond is "+ dogYears * 7 +" jaar oud in mensenjaren."
}
